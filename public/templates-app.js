angular.module('templates-app', ['about/about.tpl.html', 'home/home.tpl.html', 'shop/shop.tpl.html']);
...
angular.module("shop/shop.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("shop/shop.tpl.html",
    "<div ng-init=\"init()\">\n" +
    "    <h1>{{msg}}</h1>\n" +
    "    <ul>\n" +
